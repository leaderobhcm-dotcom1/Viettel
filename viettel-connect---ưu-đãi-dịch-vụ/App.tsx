...
import { Phone, Globe, Menu, X, ArrowRight, ShieldCheck, Clock, Award, Lock, UserCog, CheckCircle } from 'lucide-react';

// Wrapper component to use Context inside App
const AppContent = () => {
  const { user, plans, contactConfig, addLead } = useApp();
      ...
      <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-viettel-red rounded-full flex items-center justify-center text-white font-bold text-xl">
              V
            </div>
          ...
          <div className="hidden md:flex items-center gap-8 font-medium text-gray-600">
            ...
            <a href="#contact-form" onClick={(e) => handleNavClick(e, 'contact-form')} className="hover:text-viettel-red transition-colors">Liên Hệ</a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 p-4 absolute w-full shadow-xl flex flex-col gap-4 z-40">
            <a href="#mobile" className="py-2 text-gray-700 font-medium" onClick={(e) => handleNavClick(e, 'mobile')}>Gói Di Động</a>
            <a href="#internet" className="py-2 text-gray-700 font-medium" onClick={(e) => handleNavClick(e, 'internet')}>Internet Cáp Quang</a>
            <a href="#contact-form" className="py-2 text-gray-700 font-medium" onClick={(e) => handleNavClick(e, 'contact-form')}>Tư Vấn</a>
          </div>
        )}
      </nav>
